MATERIAL_SYMBOL         = "FEP"     -- To look up the material being stored (stack size, name, etc)
...
PANEL_NAME                 = "Panel"
BYPASS_BUTTON_POS          = Vector2(5, 9)
TARGET_DIAL_POS            = Vector2(5, 8)
GRAPHIC_STATUS_SCREEN_POS  = Vector2(6, 9)
TEXT_STATUS_SCREEN_POS     = Vector2(1, 9)