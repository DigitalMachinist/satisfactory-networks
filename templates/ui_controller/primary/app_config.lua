...
CONTROL_OFFSET_GRAPHIC_DISPLAY = Vector2(6, 0)
CONTROL_OFFSET_BYPASS_BUTTON   = Vector2(5, 0)
CONTROL_OFFSET_TARGET_DIAL     = Vector2(5, -1)

-- UI Display settings
UI_TEXT_DISPLAY_SIZE    = 36
UI_GRAPHIC_DISPLAY_SIZE = Vector2(119, 30)
